...
public class MarsRoverTest {
  ...
  @Test
  public void should_return_direction_N_location_x_10_y_9_when_back_given_direction_N_location_x_10_y_10() {
    MarsRover marsRover = new MarsRover(new Location(10, 10, DIRECTION.NORTH));

    marsRover.executeCommand(asList(new BackCommand()));
  ...
  @Test
  public void should_return_direction_S_location_x_10_y_11_when_back_given_direction_S_location_x_10_y_10() {
    MarsRover marsRover = new MarsRover(new Location(10, 10, DIRECTION.SOUTH));
  ...
  @Test
  public void should_return_direction_E_location_x_9_y_10_when_back_given_direction_E_location_x_10_y_10() {
    MarsRover marsRover = new MarsRover(new Location(10, 10, DIRECTION.EAST));
  ...
  @Test
  public void should_return_direction_W_location_x_11_y_10_when_back_given_direction_W_location_x_10_y_10() {
    MarsRover marsRover = new MarsRover(new Location(10, 10, DIRECTION.WEST));
